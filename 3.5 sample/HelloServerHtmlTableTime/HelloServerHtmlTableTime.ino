...
void handleRoot() {
  ...
  strHtml = "<!DOCTYPE html><html><head><title>Page Title</title></head><body><h1>This is a Heading</h1>";
  strHtml += "<table><tr><th>Firstname</th><th>Lastname</th><th>Age</th></tr><tr><td>Jill</td><td>";
  strHtml += strDateTime + "</td><td>50</td></tr><tr><td>Eve</td><td>Jackson</td><td>94</td></tr></table>";
  strHtml += "</body></html>";
